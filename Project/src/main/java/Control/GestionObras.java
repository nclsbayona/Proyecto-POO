...
public class GestionObras {
    ...
    public HashSet <Obra> listaObras(){
        ...
        obras.add(new Cuadro(2435678, "Eva pilla", fecha1.getTime(), 20000, "10x8", "Polimorfismo", "Acuarela", Clasificacion.OBRA_MAESTRA));
        fecha2.set(2001, 8, 6);
        ...
        obras.add(new Cuadro(5432198, "Okalokas", fecha4.getTime(), 20000, "10x8", "Cubismo", "Pastel", Clasificacion.OBRA_REPRESENTATIVA));
        fecha5.set(1984, 2, 3);
